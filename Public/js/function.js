...
jumlahPenggunaan.addEventListener("input", () => {
  spanDays.textContent = `${jumlahPenggunaan.value} Tahun`;
});
...
//perhitungan
       document.getElementById('btnHitung').addEventListener('click', function() {
            ...
            const jumlahPenggunaan = parseFloat(document.getElementById('jumlahPenggunaan').value * 365) || 0;
            const Etotal = (DayaMemasak * SiklusMemasak) + DayaMenghangatkan * SiklusMenghangatkan
            const kwhPenanakNasi = Etotal * jumlahPenggunaan / 1000;
